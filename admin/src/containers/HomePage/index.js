...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/lfilipe09',
  },
  {
    name: 'Blog',
    link: 'https://linktr.ee/lfilipe09',
  },
  {
    name: 'Linkedin',
    link: 'https://www.linkedin.com/in/luisdelima/',
  },
];
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>
                Em caso de dúvidas e ou sugestões,
                só ir em algum dos meus links! =)
              </P>
              <ALink
                rel="noopener noreferrer"
                href="https://github.com/lfilipe09?tab=repositories"
                target="_blank"
              >
